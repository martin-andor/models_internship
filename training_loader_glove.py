...
#Defining the first two layers and loading the pre-trained GloVe Embeddings.
...
embeddings_path = '/home/martin/master_ai/internship/pretrained_vectors/GloVe/glove.6B.200d.txt'
embedding_dictionary = utils.load_glove_embeddings(embeddings_path)

embedding_matrix = utils.get_embedding_matrix(embedding_size,
        vocab_size,
        word_index,
